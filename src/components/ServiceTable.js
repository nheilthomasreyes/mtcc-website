                ...
                <tr key={client.id ?? index} className={`hover:bg-white/5 transition-colors ${client.doNotDelete ? 'bg-red-500/5' : ''}`}>
                  ...
                  <td className="px-5 py-5">
                    {(() => {
                      ...
                      return (
                        <span 
                          className="inline-flex items-center px-3 py-1 rounded-lg text-xs font-medium border whitespace-nowrap"
                          style={{
                            backgroundColor: customHex ? `${customHex}20` : 'rgba(168, 85, 247, 0.2)', // 20% opacity
                            color: customHex ? customHex : '#d8b4fe',
                            borderColor: customHex ? `${customHex}40` : 'rgba(168, 85, 247, 0.3)'
                          }}
                        >
                          {client.category}
                        </span>
